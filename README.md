...
- [Шаг 1 - Создание структуры БД и подготовка данных](#шаг-1---создание-структуры-бд-и-подготовка-данных)
  - [ERD - итоговая схема данных](#erd---итоговая-схема-данных)
  - [Что было сделано](#что-было-сделано)
- [Шаг 2 - SQL-запросы 1-8](#шаг-2---sql-запросы-1-8)
  - [Задача 1 - бренды с высокой себестоимостью и продажами](#задача-1---бренды-с-высокой-себестоимостью-и-продажами)
  - [Задача 2 - подтвержденные онлайн-заказы по дням](#задача-2---подтвержденные-онлайн-заказы-по-дням)
  - [Задача 3 - Senior в IT и Lead в Financial Services](#задача-3---senior-в-it-и-lead-в-financial-services)
  - [Задача 4 - бренды Financial Services которых нет у IT](#задача-4---бренды-financial-services-которых-нет-у-it)
  - [Задача 5 - активные клиенты топ-брендов с valuation выше среднего](#задача-5---активные-клиенты-топ-брендов-с-valuation-выше-среднего)
  - [Задача 6 - владельцы авто не mass customer без онлайн-заказов](#задача-6---владельцы-авто-не-mass-customer-без-онлайн-заказов)
  - [Задача 7 - it-клиенты купившие ровно 2 из топ-5-road-продуктов](#задача-7---it-клиенты-купившие-ровно-2-из-топ-5-road-продуктов)
  - [Задача 8 - клиенты it и health с высокой активностью и выручкой](#задача-8---клиенты-it-и-health-с-высокой-активностью-и-выручкой)
...
![T6\_n1](img/T6_начало.png)

### Конец результата:

![T6\_n2](img/T6_конец.png)
